...
\underline{\Sigma_{m = 1}} = diag(0.1, K*K*P)
$$

$$
\underline{\lambda_{m = 1}} = rep(-1, K)

\underline{\Sigma_{m = 1}} = diag(0.1, K)
$$

$$
\underline{\lambda_{m = 2}} = rep(1, K)

\underline{\Sigma_{m = 2}} = diag(0.1, K)
$$
